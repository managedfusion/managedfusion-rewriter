...
namespace ManagedFusion.Rewriter
{
	...
	/// 
	/// </summary>
	public sealed class RefreshRulesEventArgs : EventArgs
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="RefreshRulesEventArgs"/> class.
		/// </summary>
		public RefreshRulesEventArgs()
		{
			RefreshRules = false;
		}

		/// <summary>
		/// Gets or sets a value indicating whether [refresh rules].
		/// </summary>
		/// <value>
		/// 	<see langword="true"/> if [refresh rules]; otherwise, <see langword="false"/>.
		/// </value>
		public bool RefreshRules
		{
			get; set;
		}
	}
