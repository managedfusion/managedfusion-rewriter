...
namespace ManagedFusion.Rewriter.Engines
{
	...
	/// 
	/// </summary>
	internal class ApplicationEngine : IRewriterEngine
	{
		private ApplicationRuleSet _ruleSet;
		...
		public ApplicationEngine(LoadRulesEventArgs args)
			: this(new ApplicationRuleSet(args)) { }
